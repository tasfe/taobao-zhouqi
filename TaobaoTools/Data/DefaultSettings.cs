...
namespace TaobaoTools.Data
{
    public class DefaultSettings
    {
        ...
        [DefaultValue(true), DisplayName("页面分割"), Description("生成便于页面分割的文本框"), Category("订单打印")]
        public bool ShowTextBox { get { return Settings.Default.ShowTextBox; } set { Settings.Default.ShowTextBox = value; } }
    }
}
