...
namespace TaobaoTools
{
    class Global
    {
        ...
        public class TradeCreatedCompare : Comparer<Trade>
        {
        ...
        public static TradeInfo AddTrade(List<TradeInfo> tradeInfos, Trade trade)
        {
            ...
            TradeInfo newTradeInfo = new TradeInfo(trade);
            tradeInfos.Add(newTradeInfo);
            return newTradeInfo;
        }
